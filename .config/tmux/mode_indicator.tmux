...
declare -r end_prefix_mode_style_config='@mode_indicator_end_prefix_mode_style'
declare -r end_copy_mode_style_config='@mode_indicator_end_copy_mode_style'
declare -r end_sync_mode_style_config='@mode_indicator_end_sync_mode_style'
declare -r end_empty_mode_style_config='@mode_indicator_end_empty_mode_style'
declare -r end_custom_mode_style_config="@mode_indicator_end_custom_mode_style"
...
init_tmux_mode_indicator() {
  local -r \
    ...
    end_prefix_style=$(indicator_style "$end_prefix_mode_style_config" "bg=blue,fg=black") \
    end_copy_style=$(indicator_style "$end_copy_mode_style_config" "bg=yellow,fg=black") \
    end_sync_style=$(indicator_style "$end_sync_mode_style_config" "bg=red,fg=black") \
    end_empty_style=$(indicator_style "$end_empty_mode_style_config" "bg=cyan,fg=black") \
    arrow=""
  ...
  local -r \
    ...
    end_custom_style="#(tmux show-option -t #S -qv $end_custom_mode_style_config)"
  ...
  local -r \
    ...
    end_mode_style="#{?#{!=:$end_custom_style,},#[$end_custom_style],#{?client_prefix,$end_prefix_style,#{?pane_in_mode,$end_copy_style,#{?pane_synchronized,$end_sync_style,$end_empty_style}}}}"

  local -r mode_indicator="$mode_style$mode_prompt$end_mode_style$arrow"
